...
ch_id = "1307037617489182921" # ช่องสำหรับส่ง panel

phone = "0630102037"

# Log Config

log_id = "1307037622509502505" # ไอดีช่องหลังบ้าน !

# Embed Config

m_title = "HOPE STORE"

m_tn = "https://i.pinimg.com/736x/4d/bc/41/4dbc417802306519d3a468a8853c0d21.jpg"

m_img = "https://cdn.discordapp.com/attachments/1090081082373840989/1095949438008176700/aungpao_truewallet_03.jpg"

# Role Config

role_01 = "1307035416381100144" # ไอดียศที่ 1

role01_name = "DEKHOPE" # ชื่อยศที่ 1

role_01p = "150.00" # ราคายศที่ 1 ใส่ลงท้าย .00 เช่น 10 บาท ก็คือ 10.00

role_02 = "1307035412988170260" # ไอดียศที่ 2

role02_name = "PARTNER" # ชื่อยศที่ 2

role_02p = "350.00" # ราคายศที่ 2 ใส่ลงท้าย .00 เช่น 20 บาท ก็คือ 20.00

role_03 = "1200701035946184794" # ไอดียศที่ 3

role03_name = "ALL ROLES" # ชื่อยศที่ 3

role_03p = "450.00" # ราคายศที่ 3 ใส่ลงท้าย .00 เช่น 30 บาท ก็คือ 30.00
...
async def on_ready():
    ...
    main_embed.set_footer("© Hope Store ONTOP 2025")
    ...
    match ctx.custom_id:
        case "topup_cb":
            ...
            try:
                ...
                auth = requests.get(f"https://www.planariashop.com/api/truewallet.php")
